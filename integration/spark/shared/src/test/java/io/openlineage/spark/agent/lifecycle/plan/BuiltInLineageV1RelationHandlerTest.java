...
import io.openlineage.spark.agent.lifecycle.plan.handlers.BuiltInLineageV1RelationHandler;
...
public class BuiltInLineageV1RelationHandlerTest {
  OpenLineageContext openLineageContext = mock(OpenLineageContext.class);
  DatasetFactory datasetFactory = DatasetFactory.input(openLineageContext);
  BuiltInLineageV1RelationHandler<InputDataset> handler =
      new BuiltInLineageV1RelationHandler<>(openLineageContext, datasetFactory);
