...
import io.openlineage.spark.builtin.scala.v1.OutputDatasetWithIdentifier;
...
public class SparkBuiltInV1OutputDatasetBuilderTest {

  OpenLineage openLineage = new OpenLineage(Versions.OPEN_LINEAGE_PRODUCER_URI);
  OpenLineageContext context = mock(OpenLineageContext.class);
  SparkBuiltInV1OutputDatasetBuilder builder;
  LogicalPlan plan =
  ...
  @SneakyThrows
  public void setUp() {
    builder = mock(SparkBuiltInV1OutputDatasetBuilder.class);
